...
export const IPC_CHANNELS = {
  ...
  PET_POSITION_SAVE: 'pet:positionSave',
  WINDOW_SHOW_SETTINGS: 'window:showSettings',
  ANIMATION_GET_FRAMES: 'animation:getFrames',
  ANIMATION_LIST_SKINS: 'animation:listSkins'
} as const
